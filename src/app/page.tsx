...
function SummaryTile({
  ...
  return (
    <div className="flex flex-col justify-between rounded-2xl border border-white/70 bg-white/90 p-5 shadow-lg shadow-slate-900/10 backdrop-blur">
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-100 to-slate-200 pb-16">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-12">
        <header className="relative overflow-hidden rounded-3xl bg-slate-900 text-white shadow-2xl shadow-slate-900/30">
          <HeroBackdrop />
          <div className="relative space-y-10 px-8 py-12">
        ...
        <section className="rounded-3xl border border-white/60 bg-white/90 p-8 shadow-xl shadow-slate-900/15 backdrop-blur">
